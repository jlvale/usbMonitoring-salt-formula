...
cron-grok:
  cron.present:
    - name: nohup /etc/grok-exporter/grok_exporter-1.0.0.RC3.linux-amd64/grok_exporter -config /etc/grok-exporter/grok_exporter-1.0.0.RC3.linux-amd64/example/config_usb_devices.yml &> /dev/null &
